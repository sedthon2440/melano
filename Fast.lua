...
{
{text = 'مطور الصانع', url = 't.me/T_0_M0 '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("T_0_M0")
...
{
{text = username, url = "https://t.me/T_0_M0"}
},
}
...
keyboard.inline_keyboard = {
{
{text = 'مطور السورس', url = 't.me/T_0_M0 '},
},
{  
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢', url = 't.me/Sourse1_milano '},
},
...
keyboard.inline_keyboard = {
{
{text = 'مطور السورس', url = 't.me/T_0_M0 '},{text = 'تنصيب بوت مدفوع', url = 't.me/T_0_M0'},
},
{
{text = 'قناة التحديثات', url = 't.me/Sourse1_milano '},{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢', url = 't.me/Sourse1_milano '},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
