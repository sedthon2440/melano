...
bot = Fx.Fastbots.set_config{api_id=24809997,api_hash='9fd9012cfa293957682d4ab88009af6c7',session_name=Fast,token=Token}
chsource = Redis:get(Fast..'chsource') or "Sourse1_milano"
devsource = Redis:get(Fast..'devsource') or "T_0_M0"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,1427981991,6646631745,62768358332,5986905948034,643084417482,55555555555,5555555555}
...
Status = true
elseif UserId == 6646631745 then
Status = true
elseif UserId == 55555555555 then
Status = true
elseif UserId == 596987179722 then
Status = true
elseif UserId == 5555555555 then
Status = true
elseif UserId == 598866905034 then
Status = true
elseif UserId == 62765868332 then
Status = true
...
Status = 'المبرمج توم 🤍'
elseif UserId == 6646631745 then
Status = 'مطوره السـورس 🤍'
elseif UserId == 55555555555 then
Status = 'مطـور السـورس '
elseif UserId == 64304177482 then
Status = 'مطـور السـورس '
elseif UserId == 598688905034 then
Status = ' ستك لولا يقلب امك ❤️‍🔥 '
elseif UserId == 6276865873332 then
Status = 'مطـور السـورس '
elseif UserId == Sudo_Id then  
...
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or 'مالك الگروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = Redis:get(Fast..'SetRt'..ChatId..':'..UserId) or 'مشرف الگروب'
elseif Special then
...
data = {
{
{text = '- تغيير معلومات الگروب : '..(t1 or change_info), data = UserId..'/groupNum1//'..user2}, 
},
{
...
MsgText = 'شبيك مكسر ما تتفاعل؟ '
elseif tonumber(Message) < 200 then 
MsgText = 'شد حيلك تفاعل ميعجبني'
elseif tonumber(Message) < 400 then 
MsgText = 'يعني نص ونص'
elseif tonumber(Message) < 700 then 
MsgText = 'اكو احسن من هيج 🤭'
elseif tonumber(Message) < 1200 then 
MsgText = 'تفاعلك نار حبيبي 🔥'
elseif tonumber(Message) < 2000 then 
MsgText = 'انت متفاعل حبيبي 🌚'
elseif tonumber(Message) < 3500 then 
MsgText = '؏ـمري تفاعلك حلو ضل اتفاعل ♥.'
elseif tonumber(Message) < 4000 then 
MsgText = 'استمر عاشت ايدك حب 😂🔥'
elseif tonumber(Message) < 4500 then 
MsgText = 'تستاهل كيكه على هذا التفاعل 🍰💕.'
elseif tonumber(Message) < 5500 then 
MsgText = 'انت حاركها حرك هنا 😂♥🔥'
elseif tonumber(Message) < 7000 then 
MsgText = 'تفاعلك نووي 🙂🤍.'
elseif tonumber(Message) < 9500 then 
MsgText = 'تفاعل ام عبير وهي بتكلم ام احمد عشان تجوز احمد لعبير'
elseif tonumber(Message) < 66466317451 then 
MsgText = 'خلاص انت شعلت التفاعل 😅🔥💕.'
end 
return MsgText 
end
...
{
{text = '- تغيير معلومات الگروب : '..info, data = UserId.. '/info'}, 
},
{
...
edit(ChatId,MsgId,"• صلاحيات الگروب - ", 'md', false, false, reply_markup)
end
...
if tonumber(senderr) == 1427981991 then
msg.Name_Controller = 'المبرمج توم 🤍🔥.'
msg.The_Controller = 1
elseif tonumber(senderr) == 6646631745 then
msg.Name_Controller = 'مطوره السورس اسراء 🤍🔥.'
msg.The_Controller = 1
elseif tonumber(senderr) == 55555555555 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 64304817482 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 5986873905034 then
msg.Name_Controller = 'ستك لولا يقلب امك 🌝🤍 '
msg.The_Controller = 1
elseif tonumber(senderr) == 596899871722 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 627688358332 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if msg.Asasy then
i = 0 
txx = "قائمه ملفاتك (*اضغط على اسم ملف ليتم نسخه*)\n\n"
for v in io.popen('ls plugin'):lines() do
...
if msg.sender_id.user_id == tonumber(1427981991) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج توم نورت الگروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(6646631745) then
send(msg_chat_id,msg_id,"هلا بيج عزيزتي المبرمجه اسراء ملكه السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(5986905099934) then
...
Welcome = Welcome:gsub('{الگروب}',(Get_Chat.title or '---')) 
...
GroupsWelcome = GroupsWelcome:gsub('{الگروب}',(Get_Chat.title or '---')) 
...
if type == "kick" then 
return bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0), send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في الگروب وتم طرده").Reply,"md",true)
end
if type == "del" then 
return bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في الگروب وتم تقييده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(Fast.."SilentGroup:Group"..msg.chat_id,tonumber(msg.sender_id.user_id)) 
return send(msg_chat_id,msg_id,Reply_Status(msg.sender_id.user_id,"• قام بالتكرار في الگروب وتم كتمه").Reply,"md",true)  
end
end
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[ميلانو]")
...
return send(msg_chat_id,msg_id,"• لا استطيع تغيير صوره الگروب لاني لست ادمن او ليست لديه الصلاحيه ","md",true)    
end
Redis:del(Fast.."Chat:Photo"..msg_chat_id..":"..msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔︙تم تغيير صوره الگروب بنـجاح ","md",true)    
end
...
return send(msg_chat_id,msg_id,"⌔︙تم حفظ ترحيب الگروب","md",true)     
end
...
Redis:del(Fast.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔︙تم حفظ قوانين الگروب","md",true)  
end  
...
return send(msg_chat_id,msg_id,"⌔︙تم الغاء حفظ وصف الگروب","md",true)   
end 
bot.setChatDescription(msg_chat_id,text) 
Redis:del(Fast.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender_id.user_id)
return send(msg_chat_id,msg_id,"⌔︙تم حفظ وصف الگروب","md",true)  
end  
...
send(msg_chat_id,msg_id,"⌔︙تمت الاذاعه الى *- "..#list.." * گروب في البوت ","md",true)      
Redis:del(Fast.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender_id.user_id) 
return false
end
------------------------------------------------------------------------------------------------------------
...
local list = Redis:smembers(Fast.."ChekBotAdd")   
send(msg_chat_id,msg_id,"⌔︙تم التوجيه الى *- "..#list.." * گروب في البوت ","md",true)      
for k,v in pairs(list) do  
...
send(msg_chat_id,msg_id,'• لا يوجد صوتيه بهذا الاسم في الگروب')
Redis:del(Fast.."Add:audio:Games"..msg.sender_id.user_id..":"..msg.chat_id)
return false
end
...
if text == 'گروبات البوت' or text == 'گروبات البوت' or text == 'لينك الگروبات' then
if not msg.Asasy then 
...
send(msg_chat_id,msg_id,'• جاري استرجاع المشتركين والگروبات ...')
Y = 0
...
return send(msg_chat_id,msg_id,'⌔︙تم استرجاع {'..X..'} گروب \n• واسترجاع {'..Y..'} مشترك في البوت')
end
end
...
send(msg_chat_id,msg_id,"\n*• عذرا هذا الگروب محظور من قبل المطور الاساسي سوف اغادر*","md",true)  
sleep(2)
...
return send(msg_chat_id,msg_id,'•عدد الاعضاء قليل لا يمكن تفعيل الگروب  يجب ان يكوم اكثر من :'..Redis:get(Fast..'Num:Add:Bot'),"md",true)  
end
return send(msg_chat_id,msg_id,'\n*•الگروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n⌔︙تم تفعيلها مسبقا *',"md",true)  
else
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
data = {
{
{text = '- مغادرة الگروب ', data = '/leftgroup@'..msg_chat_id}, 
},
{
...
return send(msg_chat_id,msg_id,'\n*•الگروب : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n⌔︙تم تفعيل الگروب *','md', true, false, false, false, reply_markup)
end
end 
...
return send(msg_chat_id,msg_id,"\n*• عذرا انته لست ادمن او مالك الگروب *","md",true)  
end
...
local list = Redis:smembers(Fast.."ChekBotAdd")
send(Sudo_Id,0,"*⌔︙تم تفعيل گروب تلقائيا عن طريق البوت*\n• اصبح عدد گروباتك *"..#list.."* مجموعه","md",true)
end
...
if text and text:match('^حظر گروب (-100%d+)$') then
local Chatid = text:match('^حظر گروب (-100%d+)$')
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔︙هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Get_Chat = bot.getChat(Chatid)
...
send(msg_chat_id,msg_id,'- تم حظر الگروب  : ['..Get_Chat.title..']\n - وتم مغادره البوت من الگروب')
end 
if text and text:match('^الغاء حظر گروب (-100%d+)$') then
local Chatid = text:match('^الغاء حظر گروب (-100%d+)$')
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*⌔︙هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
Redis:srem(Fast.."Black:listBan:",Chatid)
send(msg_chat_id,msg_id,'- تم الغاء حظر الگروب ')
end 
...
local name_parlo = bot.getUser(1427981991).first_name.." "..bot.getUser(1427981991).last_name
local caption = "اليك قائمه مطورين سورس توم :"
if tonumber(UserId_Info.id) ~= 1427981991 then
...
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@1427981991'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/Sourse1_milano ", 'md', true)
end
...
if text and text:match("^رشايزق (.*)$") then
local TextName = text:match("^رشتيخيخق (.*)$")
...
if text and text:match("^تفتيننيزاعل (.*)$") then
local TextName = text:match("^تفاوينثنعل (.*)$")
...
if text == "حذف قسم" then
  ...
  if ChannelJoin(msg) == false then
  local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Sourse1_milano'}, },}}
  ...
  `#stast` ↬ رتبة المستخدم
  ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
  ملحوظه لو حطيت كليشه ميديا لازم الازرار تحتوي على ميديا ميصير نص ولو دخلت نص فقط حيصير تعديل كابشن الميدي فقط
  ]],"md",true)  
  return false
  end
  end
...
if #list == 0 then
text = "• عذرا لا يوجد اقسام في الگروب"
end
...
if (StatusMember == "chatMemberStatusCreator") then
return send(msg_chat_id,msg_id,"• الصلاحيات : مالك الگروب","md",true) 
elseif (StatusMember == "chatMemberStatusAdministrator") then
StatusMemberChat = 'مشرف الگروب'
else
return send(msg_chat_id,msg_id,"• الصلاحيات : عضو في الگروب" ,"md",true) 
end
...
return send(msg_chat_id,msg_id,"• الصلاحيات : مشرف الگروب"..(PermissionsUserr or '') ,"md",true) 
end
end
...
local Texting = {'ملاك وناسيك بگروبنه😟',"حلغوم والله☹️ ","اطلق صوره🐼❤️","كيكك والله🥺","لازك بيها غيرها عاد😒",}
...
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,'• البوت عضو في الگروب ',"md",true) 
end
...
PermissionsUser = '*\n• صلاحيات البوت : مشرف في الگروب :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..'\n• تغيير المعلومات : '..change_info..'\n• تثبيت الرسائل : '..pin_messages..'\n• اضافه مستخدمين : '..invite_users..'\n• مسح الرسائل : '..delete_messages..'\n• حظر المستخدمين : '..restrict_members..'\n• اضافه المشرفين : '..promote..'\n\n*'
return send(msg_chat_id,msg_id,PermissionsUser,"md",true) 
end
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(1427981991) then
...
send(msg_chat_id,msg_id,"*\n⌔︙تم مغادرة الگروب بامر من المطور *","md",true)  
...
if text == 'اسراء' or text == 'سرو' then
photo = "https://t.me/YQYQY6"
local T =[[
[نعم تفضل وياك اسراء مطوره بوت ميلانو ♡](t.me/YQYQY6 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🍓 ـ♕︎ٰ 𝑬𝒔ٝ𝒓ٰۭ𝒂ٛ𝒂 ♕︎', url = "https://t.me/YQYQY6"}
},
{
...
photo = "https://t.me/T_0_M0"
local T =[[
[نعم عزيزي تفضل وياك توم](t.me/T_0_M0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝗧𝗢𝗠', url = "https://t.me/T_0_M0"}
},
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢', url = "https://t.me/Sourse1_milano"}
},
...
if text == 'ةينيمك' or text == 'نيمقحثث' then
...
if text == 'ويتيي' or text == 'فرظيمباولا' then
...
photo = "https://t.me/Sourse1_milano"
local T =[[
...
⌔︙تبرع + المبلغ ↢ للتبرع من فلوسك للحسابات البنكيه الاخرى بالبوت + تبرعاتي + توب المتبرعين
...
⌔︙شرطه ↢ بالرد علي الحرامي الي زرفك لاسترداد اموالك مره اخرى وسجنه •
...
keyboard.inline_keyboard = {
{
{text = '‹ مطور السورس › .', url = "https://t.me/T_0_M0"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
⌔︙اكتب ⦗ طلقها ⦘ للأزواج
⌔︙اكتب ⦗ اخلعو ⦘ للزوجات
⌔︙اكتب ⦗ توب المتزوجين ⦘ لعرض اغنى توب زواج بالبوت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'تيتييمييك' or text == 'hduei' or text == 'hdpsp' then   
photo = "https://t.me/Sourse1_milano"
local T =[[
— — — — — — — — —— — — 
...
if text == 'المبرمج' or text == 'توم' or text  == 'المبرمج توم' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(1427981991,0,'*\n⌔︙مرحباً عزيزي المبرمج توم \nشخص ما يحتاج الي مساعده\nٴ𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳\n⌔︙اسمه :- '..klajq..' \n⌔︙ايديه :-  : '..msg.sender_id.user_id..'\n⌔︙- معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'فواتبفا' or text == 'تيميميحب'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(6646631745,0,'*\n⌔︙مرحباً عزيزتي اسراء مطوره السورس \n⌔︙شخص ما يحتاج الي مساعده\nٴ𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳𓏳 \n⌔︙اسمه :- '..klajq..' \n⌔︙ايديه :-  : '..msg.sender_id.user_id..'\n⌔︙- معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'لولا' or text == 'مرات التوم'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(598690582034,0,'*\n⌔︙مرحباً عزيزتي لولا قلب التوم هناك \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢━━━━⩺ \n⌔︙اسمه :- '..klajq..' \n⌔︙ايديه :-  : '..msg.sender_id.user_id..'\n⌔︙- معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == "صورتي" then
...
{{text="وضع بوتي",data="/ChangeBotVip:"..senderr}},{{text="وضع گروبي",data="/ChangeGroupVip:"..senderr}},
{{text="اخفاء",data="/HideChanneVip:"..senderr}},
{{text='‹ قناة السورس ›',url='t.me/'..chsource..''}},
}
}
...
if text =='الغاء' then 
bot.sendText(msg_chat_id,msg_id, '* ⌔︙تم الغاء حفظ گروبك *',"md",true)  
Redis:del(Fast..'SetGroupVip'..senderr)
return false  
end 
Redis:del(Fast..'SetGroupVip'..senderr)
Redis:set(Fast..'SOFI:Group:Vip'..senderr,text)
local text = "*⌔︙تم حفظ گروبك بنجاح ✅*"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text="تغيير گروبي",data="/ChangeGroupVip:"..senderr},{text="حذف گروبي",callback_data="/DelGroupVip:"..senderr}},
...
if text and text:match("^ضع گروبي$") or text and text:match("^وضع گروبي$") then
if not msg.Admin then
return send(msg_chat_id,msg_id,'*\n ⌔︙عذرآ الامر يخص〘 '..Controller_Num(7)..' 〙*',"md",true)  
end
...
{{text="وضع گروبي",data="/ChangeGroupVip:"..senderr}},{{text="وضع قناتي",data="/ChangeChanneVip:"..senderr}},
...
return send(msg_chat_id,msg_id,"⌔︙ارسل رابط الگروب او رابط قناة الگروب","md",true)  
end
...
return send(msg_chat_id,msg_id,"• لم يتم تعيين ترحيب للگروب","md",true)   
end 
end
...
return send(msg_chat_id,msg_id,"⌔︙تم ازالة ترحيب الگروب","md",true)   
end
...
return send(msg_chat_id,msg_id,"⌔︙تم ازالة قوانين الگروب","md",true)    
end
...
return send(msg_chat_id,msg_id,"⌔︙ارسل لي وصف الگروب الان","md",true)  
end
...
return send(msg_chat_id,msg_id,"⌔︙تم تغيير اسم الگروب الى : "..NameChat,"md",true)    
end
...
return send(msg_chat_id,msg_id,"⌔︙ارسل الصوره لوضعها للگروب","md",true)    
end
...
local permissions = '*\n• صلاحيات الگروب :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..'\n• ارسال الويب : '..web..'\n• تغيير معلومات الگروب : '..info..'\n• اضافه مستخدمين : '..invite..'\n• تثبيت الرسائل : '..pin..'\n• ارسال الميديا : '..media..'\n• ارسال الرسائل : '..messges..'\n• اضافه البوتات : '..other..'\n• ارسال استفتاء : '..polls..'*\n\n'
local TextChat = '*\n• معلومات الگروب :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉'..' \n• اسم الگروب : ❬* ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* ❭\n• عدد الادمنيه : ❬ '..Info_Chats.administrator_count..' ❭\n• عدد المحظورين : ❬ '..Info_Chats.banned_count..' ❭\n• عدد الاعضاء : ❬ '..Info_Chats.member_count..' ❭\n• عدد المقيديين : ❬ '..Info_Chats.restricted_count..' ❭\n• الايدي : ❬ *`'..msg.chat_id..'`* ❭*\n'
...
{
{text = '- تغيير معلومات الگروب : '..info, data =senderr..  '/info'}, 
},
{
...
return send(msg_chat_id,msg_id,'\n*⌔︙هذا الامر يخص { '..Controller_Num(8)..' , مالك الگروب }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
...
return send(msg_chat_id,msg_id,'\n*⌔︙تم تنزيل جميع رتب الگروب { المنشئين الاساسسين , المنشئين , المدراء , الادمنيه  }* ',"md",true)  
end
...
if text == 'تفاعل الگروب' and msg.reply_to_message_id == 0 then
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(Fast..'Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(Fast..'Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لأستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,"• تفاعل الگروب : "..MsgText, "md")
end
if text == "مين انا" then
if msg.sender_id.user_id == tonumber(1427981991) then
send(msg_chat_id,msg_id,"⌔︙انت توم مطور السورس 🤍. ","md",true)
elseif msg.sender_id.user_id == tonumber(6646631745) then
send(msg_chat_id,msg_id,"⌔︙انتي اسراء مطوره السورس 🤍. ","md",true)
elseif msg.sender_id.user_id == tonumber(627658332) then
send(msg_chat_id,msg_id,"⌔︙انت مانو مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(59869805034) then
send(msg_chat_id,msg_id,"انتي [لولا مرات توم] يقلبي 🥺♥","md",true)
...
send(msg_chat_id,msg_id,"⌔︙انت مالك الگروب","md",true)
...
if #list == 0 then
text = "• عذرا لا يوجد ردود مضافه في الگروب"
end
return send(msg_chat_id,msg_id,"["..text.."]","md",true)  
end
if text == "اضف رد" then
...
if #list == 0 then
text = "• عذرا لا يوجد ردود انلاين في الگروب"
end
return send(msg_chat_id,msg_id,"["..text.."]","md",true)
end
---------
...
local list = Redis:smembers(Fast.."List:Manager:inline:sudo")
text = "⌔︙قائمة الردود الانلاين عام \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if #list == 0 then
text = "• عذرا لا يوجد ردود انلاين عام في الگروب"
end
return send(msg_chat_id,msg_id,"["..text.."]","md",true)
end
--------------
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(1427981991) then
local txx = "\n"
...
return send(msg_chat_id,msg_id,'\n⌔︙مرحبا بك في السجل المدني الخاص بسورس 𝗠𝗜𝗟𝗔𝗡𝗢\nاكتب اسمك الان :',"md",true)  
end
...
if text and (text == "h7e8e" or text == "↫ متحركه ✯") and not Redis:get(Fast..'Abs:gif:Abs'..msg.chat_id) then
...
if text and (text == "ueie" or text == "↫ ميمز ✯") and not Redis:get(Fast..'Abs:memz:Abs'..msg.chat_id) then
...
if text and (text == "hsuue" or text == "↫ ريمكس ✯") and not Redis:get(Fast..'Abs:Remix:Abs'..msg.chat_id) then
...
if text and (text == "صورyr7ه" or text == "↫ صوره ✯") and not Redis:get(Fast..'Abs:Photo:Abs'..msg.chat_id) then
...
if text and (text == "انمyr7eي" or text == "↫ انمي ✯") and not Redis:get(Fast..'Abs:Anime:Abs'..msg.chat_id) then
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/Sourse1_milano"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/Sourse1_milano"}
},
}
local msg_id = msg.id/2097152/0.5
...
if text and (text == "فاثتثلم" or text == "↫ فلم ✯") and not Redis:get(Fast..'Abs:Movies:Abs'..msg.chat_id) then
...
if text and (text == "مستببمملسل" or text == "↫ مسلسل ✯") and not Redis:get(Fast..'Abs:Series:Abs'..msg.chat_id) then
...
return send(msg_chat_id,msg_id,'⌔︙ارسل تفعيل معنى اسم\n ༄',"md")
end
end
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@Sourse1_milano")
sleep(1)
...
data = {
{
{text = '‹ قناة السورس ›', url = 'http://t.me/'..chsource..''}, {text = '‹ مطور السورس ›', url = 't.me/'..devsource}, 
},
{
...
if text == (Redis:get(Fast.."Name:Bot") or "ميلانو") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "ميلانو")
local Mostafa = {
'نعم حبيبي تفضل',
'لا تصيحلي',
'شتريد',
...
x = x + 1
send(Get_Chat.id,0,'*• البوت عضو في الگروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
...
if #mem_num == 0 then
return send(msg_user_send_id,msg_id,'• انتظر حتي انضمام لاعب واحد على الاقل',"md",true) 
end
...
if text == 'توم' or text == 'مبرمج السورس' or text == 'bdhdjidi' then  
local UserId_Info = bot.searchPublicChat("T_0_M0")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = ".𖣂. 𝗗𝗘𝗩 𝗧𝗢𝗠\n— — — — — — — — —\n.𖣂.*𝗗𝗘𝗩 𝗡𝗔𝗠𝗘* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n.𖣂.*𝗕𝗜𝗢* : [ "..Bio.." ]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' 𝗧𝗢𝗠 ', url = "https://t.me/T_0_M0"}
...
keyboardd.inline_keyboard = {
{
{text = ' المطور توم ', url = "https://t.me/T_0_M0"}
},
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢', url = "https://t.me/Sourse1_milano"},
},
...
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗠𝗜𝗟𝗔𝗡𝗢](t.me/Sourse1_milano)
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*⌔︙مرحبا انا بوت اسمي '..(Redis:get(Fast.."Name:Bot") or "ميلانو")..' \n⌔︙اختصاصي التسليه وحماية المجموعات\n⌔︙من المخربين والتفليش والسبام والخ\n⌔︙فقط قم برفعي ادمن في مجموعتك\n⌔︙وارسل كلمة ← ‹ تفعيل ›\n⌔︙سيتم رفع الادمنيه والمالك تلقائيا\n⌔︙لاضهار كيبورد الاوامر ⦗ /MILANO ⦘\n⌔︙مطور البوت ← ⦗ @'..UserSudo..' ⦘*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = Name_dev, url = "t.me/"..UName_dev },{text = Name_User, url = "t.me/"..UserInfo.username},
},
{
{text = 'ضيفني لـ مجموعتك 🧚🏻‍♂️', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
